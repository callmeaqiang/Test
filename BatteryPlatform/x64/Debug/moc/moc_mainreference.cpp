...
QT_MOC_LITERAL(3, 32, 22), // "QList<InstructingData>"
QT_MOC_LITERAL(4, 55, 4) // "data"

    },
    "MainReference\0instructDataList\0\0"
    "QList<InstructingData>\0data"
};
...
void MainReference::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->instructDataList((*reinterpret_cast< const QList<InstructingData>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (MainReference::*_t)(const QList<InstructingData> );
...
// SIGNAL 0
void MainReference::instructDataList(const QList<InstructingData> _t1)
{
