/********************************************************************************
** Form generated from reading UI file 'smokingtestdialog.ui'
**
...
#ifndef UI_SMOKINGTESTDIALOG_H
#define UI_SMOKINGTESTDIALOG_H
...
public:
    ...
    void setupUi(QDialog *SmokingTestDialog)
    {
        if (SmokingTestDialog->objectName().isEmpty())
            SmokingTestDialog->setObjectName(QStringLiteral("SmokingTestDialog"));
        SmokingTestDialog->resize(391, 265);
        QIcon icon;
        icon.addFile(QStringLiteral(":/res/res/battery.png"), QSize(), QIcon::Normal, QIcon::Off);
        SmokingTestDialog->setWindowIcon(icon);
        SmokingTestDialog->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"		\n"
...
"    padding-top:13px;\n"
"}\n"
"QDialog#SmokingTestDialog{	\n"
"	background-color: rgb(255, 255, 255);\n"
"}"));
        verticalLayout_2 = new QVBoxLayout(SmokingTestDialog);
        ...
        label_2 = new QLabel(SmokingTestDialog);
        ...
        lineEdit_testname = new QLineEdit(SmokingTestDialog);
        ...
        groupBox = new QGroupBox(SmokingTestDialog);
        ...
        SaveBtn = new QPushButton(SmokingTestDialog);
        SaveBtn->setObjectName(QStringLiteral("SaveBtn"));

        horizontalLayout_2->addWidget(SaveBtn);

        ModifyBtn = new QPushButton(SmokingTestDialog);
        ...
        ReturnBtn = new QPushButton(SmokingTestDialog);
        ...
        retranslateUi(SmokingTestDialog);

        QMetaObject::connectSlotsByName(SmokingTestDialog);
    } // setupUi

    void retranslateUi(QDialog *SmokingTestDialog)
    {
        SmokingTestDialog->setWindowTitle(QApplication::translate("SmokingTestDialog", "SmokingTestDialog", Q_NULLPTR));
        label_2->setText(QApplication::translate("SmokingTestDialog", "please enter test name:", Q_NULLPTR));
        lineEdit_testname->setText(QString());
        groupBox->setTitle(QApplication::translate("SmokingTestDialog", "Parameter Setting\357\274\232", Q_NULLPTR));
        label->setText(QApplication::translate("SmokingTestDialog", "charge voltage:", Q_NULLPTR));
        lineEdit_chargeVoltage->setInputMask(QString());
        lineEdit_chargeVoltage->setPlaceholderText(QString());
        label_9->setText(QApplication::translate("SmokingTestDialog", "V", Q_NULLPTR));
        label_15->setText(QApplication::translate("SmokingTestDialog", "charge current:", Q_NULLPTR));
        lineEdit_chargeCurrent->setPlaceholderText(QString());
        label_13->setText(QApplication::translate("SmokingTestDialog", "A", Q_NULLPTR));
        label_16->setText(QApplication::translate("SmokingTestDialog", "discharge current:", Q_NULLPTR));
        lineEdit_dischargeCurrent->setPlaceholderText(QString());
        label_14->setText(QApplication::translate("SmokingTestDialog", "A", Q_NULLPTR));
        SaveBtn->setText(QApplication::translate("SmokingTestDialog", "SaveBtn", Q_NULLPTR));
        ModifyBtn->setText(QApplication::translate("SmokingTestDialog", "ModifyBtn", Q_NULLPTR));
        ReturnBtn->setText(QApplication::translate("SmokingTestDialog", "Return", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class SmokingTestDialog: public Ui_SmokingTestDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SMOKINGTESTDIALOG_H
